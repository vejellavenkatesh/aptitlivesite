...
public class WorkshopReg {
	...
	public WorkshopReg(long id, String name, String email, String mobile, String collegename, String collegeid,
			String collegLocation, String choosedomain, String timeduration, String anyquiries, byte[] certificates,
			byte[] anyattachments) {
		super();
		this.id = id;
		this.name = name;
	...
	public String toString() {
		return "WorkshopReg [id=" + id + ", name=" + name + ", email=" + email + ", mobile=" + mobile + ", collegename="
				+ collegename + ", collegeid=" + collegeid + ", collegLocation=" + collegLocation + ", choosedomain="
				+ choosedomain + ", timeduration=" + timeduration + ", anyquiries=" + anyquiries + ", certificates="
				+ Arrays.toString(certificates) + ", anyattachments=" + Arrays.toString(anyattachments) + "]";
	}
	public WorkshopReg() {
		super();
