...
public class InternshipForm {
		...
		public void setCollegeLocation(String collegeLocation) {
			this.collegLocation = collegeLocation;
		}
		...
		public InternshipForm(long id, String name, String email, String mobile, String collegename, String collegeid,
				String collegeLocation, String choosedomain, String timeduration, String anyquiries,
		...
		public String toString() {
			return "InternshipForm [id=" + id + ", name=" + name + ", email=" + email + ", mobile=" + mobile
					+ ", collegename=" + collegename + ", collegeid=" + collegeid + ", collegeLocation="
					+ collegLocation + ", choosedomain=" + choosedomain + ", timeduration=" + timeduration
					+ ", anyquiries=" + anyquiries + ", certificates=" + Arrays.toString(certificates)
					+ ", anyattachments=" + Arrays.toString(anyattachments) + "]";
		}
